// app/thong-tin-dat-hang/page.jsx or OrderInfo.jsx as the main component
'use client';

import Link from 'next/link';
import { useRouter } from 'next/navigation';
import { useState, useEffect } from 'react';
import styles from './OrderInfo.module.scss'; // Assuming you have a separate SCSS for this, or reuse from Cart if similar
...
export default function OrderInfo() {
  ...
  // Fetch cart items to display summary (similar to Cart)
  useEffect(() => {
  ...
  return (
    <main className={styles.wrapperMain_content}> {/* Reuse styles from Cart if possible */}
      <div className={styles.cartBox}> {/* Adapt to order info box */}
        <ContainerFluid>
          ...
          <div className={styles.cardMain}>
            ...
            <section className={styles.sectionSteps}>
              <div className={styles.progressBar}>
                ...
                <div className={styles.stepActive} data-box="cart-info-order-box">
                  <div className={styles.stepIcon}>
                    <svg viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Order Info Form and Cart Summary */}
