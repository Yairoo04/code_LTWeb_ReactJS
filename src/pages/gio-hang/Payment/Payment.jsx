// app/thanh-toan/page.jsx or Payment.jsx as the main component
'use client';
...
export default function Payment() {
  ...
  useEffect(() => {
    ...
    if (!info) {
      alert('Không tìm thấy thông tin đặt hàng. Vui lòng quay lại bước trước.');
  ...
  const handlePayment = async () => {
    const token = localStorage.getItem('token');
    if (!token) {
      alert("Bạn phải đăng nhập mới đặt hàng được!");
  ...
  // Calculate total
  const total = cartItems.reduce((sum, item) => sum + item.PriceAtAdded * item.Quantity, 0);
          ...
          <div className={styles.cardMain}>
            ...
            <section className={styles.sectionSteps}>
              <div className={styles.progressBar}>
                ...
                <div className={styles.stepActive} data-box="cart-payment-order-box">
                  <div className={styles.stepIcon}>
                    <svg viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Payment and Summaries */}
            <section className={styles.sectionOrder}>
              <div className={styles.paymentBox}>
                <h2>Thanh toán đơn hàng</h2>
                {orderInfo && (
                  <div className={styles.orderSummary}>
                    <p><strong>Họ và tên:</strong> {orderInfo.recipientName}</p>
              ...
              <div className={styles.cartSummary}>
                ...
                {cartLoading ? (
                  ...
                  <>
                    ...
                    <p className={styles.total}><span className={styles.totalTitle}>Tổng cộng:</span> {total.toLocaleString()}đ</p>
                  </>
                )}
              </div>
            </section>
