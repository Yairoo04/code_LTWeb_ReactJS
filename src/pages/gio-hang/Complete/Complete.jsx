// app/hoan-tat/page.jsx or Complete.jsx as the main component
'use client';
...
import ContainerFluid from '../../main_Page/ContainerFluid/container-fluid'; // Adjust path as needed
          ...
          <div className={styles.cardMain}>
            ...
            <section className={styles.sectionSteps}>
              <div className={styles.progressBar}>
                <div className={styles.step} data-box="cart-buy-order-box">
                ...
                <div className={styles.step} data-box="cart-info-order-box">
                  <div className={styles.stepIcon}>
                    <svg viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <circle cx="14.4009" cy="14" r="14" fill="#E30019"></circle>
                ...
                <div className={styles.stepActive}>
                  <div className={styles.stepIcon}>
                    <svg viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <circle cx="14.4321" cy="14" r="14" fill="#E30019"></circle>
                      <path d="M13.0988 17.1818L10.4321 14.6364L11.3721 13.7391L13.0988 15.3809L17.4921 11.1873L18.4321 12.0909M14.4321 7L8.43213 9.54545V13.3636C8.43213 16.8955 10.9921 20.1982 14.4321 21C17.8721 20.1982 20.4321 16.8955 20.4321 13.3636V9.54545L14.4321 7Z" fill="white"></path>
                    </svg>
                  </div>
              ...
              <div className={styles.completeBox}>
                ...
                {loading ? (
                  ...
                  <div className={styles.orderSummary}>
                    ...
                    <p><strong>Họ và tên:</strong> {orderDetails?.recipientName || "Không có dữ liệu"}</p>
                    <p><strong>Số điện thoại:</strong> {orderDetails?.recipientPhone || "Không có dữ liệu"}</p>
                    <p><strong>Địa chỉ:</strong> {orderDetails?.recipientAddress || "Không có dữ liệu"}</p>
                    ...
                    <p className={styles.total}>
                      ...
                      {(
                        orderDetails?.total ??
                        orderDetails?.totalAmount ??   // fallback nếu backend trả totalAmount
                        0
                      ).toLocaleString()}đ
                    </p>
                  </div>
