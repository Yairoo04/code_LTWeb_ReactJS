...
import styles from './chinh-sach-giao-hang.module.scss';
        ...
        <>
            ...
            <div className={common.showroomSystemContainer}>
                ...
                <div className={styles.content}>
                    <h2 className={styles.titlePage}>Chính sách vận chuyển</h2>

                    <section className={styles.intro}>
                        <p>
                            <b><i>GTN cung cấp dịch vụ giao hàng toàn quốc, giao hàng tận nơi đến địa chỉ cung cấp của Quý khách.</i></b>
                        </p>
                        <p>Thời gian giao hàng dự kiến phụ thuộc vào khu vực địa chỉ nhận hàng của Quý khách. Đa phần đơn hàng GTN cần vài giờ làm việc để kiểm tra thông tin và đóng gói. Nếu sản phẩm có sẵn, GTN sẽ nhanh chóng bàn giao cho đối tác vận chuyển.</p>
                    </section>

                    <section className={styles.shippingFee}>
                        <h3>Phí dịch vụ giao hàng</h3>
                        <table className={styles.tableChinhSach}>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td colSpan="3" className={styles.highlight}>GIAO HÀNG NHANH 2H ĐẾN 4H</td>
                                </tr>
                                <tr>
                        ...
                        <p className={styles.effectiveDate}><i>Chính sách này có hiệu lực từ ngày 03/09/2025</i></p>
                    </section>

                    <section className={styles.deliveryTime}>
                        <h3>Thời gian dự kiến giao hàng</h3>
                        <table className={styles.tableTuyen}>
                            <thead>
                                <tr>
                                    <th>Tuyến</th>
                                    <th>Khu vực</th>
                    ...
                    <section className={styles.receiveTips}>
                        <h3>Một số lưu ý khi nhận hàng</h3>
                        <ul className={styles.luuYNhanHang}>
                            ...
                            <li>Thay đổi/hủy đơn liên hệ <a href="tel:19005301">1900.5301</a>, fanpage hoặc <a href="https://GTN.com/">website</a>.</li>
                        </ul>
                    </section>
                </div>
            </div>
