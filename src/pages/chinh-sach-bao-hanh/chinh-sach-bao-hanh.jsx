        ...
        <>
            ...
            <div className={common.showroomSystemContainer}>
                ...
                <div className={styles.policyContent}>
                    ...
                    <p>
                        GTN cam kết mang đến cho khách hàng dịch vụ hậu mãi tốt nhất với chính sách bảo hành rõ ràng,
                        minh bạch và nhanh chóng. Tất cả sản phẩm khi mua tại GTN đều được hưởng chế độ bảo hành chính
                        hãng hoặc bảo hành tại hệ thống GTN tùy theo từng sản phẩm.
                    </p>

                    <h2>I. Điều kiện bảo hành</h2>
                    <ul>
                        <li>Sản phẩm còn trong thời hạn bảo hành được tính kể từ ngày mua hàng.</li>
                        <li>Sản phẩm phải còn tem bảo hành của hãng hoặc của GTN.</li>
                        <li>
                    ...
                    <ul>
                        ...
                        <li>Sản phẩm đã được sửa chữa ở nơi khác ngoài hệ thống GTN hoặc TTBH chính hãng.</li>
                    </ul>

                    <h2>III. Thời gian bảo hành</h2>
                    <p>
                        GTN tiếp nhận và xử lý bảo hành trong thời gian nhanh nhất có thể. Thông thường, thời gian bảo
                    ...
                    <ul>
                        <li>Đem trực tiếp sản phẩm đến hệ thống cửa hàng GTN trên toàn quốc.</li>
                        <li>Gửi sản phẩm qua đường bưu điện / chuyển phát nhanh về trung tâm bảo hành của GTN.</li>
                    </ul>

                    <h2>VI. Liên hệ hỗ trợ</h2>

                    <div className={styles.contactInfo}>
                        <p>Khi có nhu cầu bảo hành sản phẩm, khách hàng vui lòng liên hệ với GTN qua các hình thức:</p>
                        <ul>
                            <li>
                            ...
                            <li>
                                🏢 Mang sản phẩm trực tiếp đến các chi nhánh cửa hàng hoặc Trung tâm bảo hành của GTN
                            </li>
                            <li>🏭 Mang sản phẩm trực tiếp đến Trung tâm bảo hành của hãng/nhà cung cấp</li>
                        </ul>
                        <p>Xem hệ thống Showroom GTN tại đây:</p>
                        <div className={styles.mapSection}>
                            <h2>Hệ thống Showroom GTN</h2>
                    ...
                    <div className={styles.note}>
                        Khách hàng cũng có thể gửi sản phẩm bảo hành thông qua đơn vị vận chuyển. GTN sẽ phản hồi thông
